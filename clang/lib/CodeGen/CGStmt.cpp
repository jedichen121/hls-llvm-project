...
void CodeGenFunction::EmitAttributedStmt(const AttributedStmt &S) {
  ...
  // PrettyStackTraceLoc CrashInfo(getContext().getSourceManager(),S.getAttrLoc(),
  //                            "LLVM IR generation of xlx statement");
  // assert(isa<NullStmt>(S.getSubStmt()) && "isa<NullStmt>(S.getSubStmt())");
  ...
  if (isa<NullStmt>(S.getSubStmt())) {
    for(auto* A: Attrs) {
      ...
      //}
        ...
        assert(false && "about to run EmitSAXILITEOffsetIntrinsic");
